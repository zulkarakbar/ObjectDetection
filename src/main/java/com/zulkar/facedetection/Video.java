...
public class Video {
	...
	public static void main(String[] args) throws Exception {
		...
		String classifierFile = "C:/Users/zulkar.nain/eclipse-workspace/FaceDetection/facedetection/resourcesfiles/haarcascade_frontalface_default.xml";
		...
		// FFmpegFrameGrabber.
		File videoFileName = new File("C:/Users/zulkar.nain/Downloads/Punchnama.mp4");
		OpenCVFrameGrabber grabber = new OpenCVFrameGrabber(videoFileName);
		// FrameGrabber grabber = FrameGrabber.createDefault(videoFileName);
		grabber.start();
		...
		Mat grabbedImage = converter.convert(grabber.grabFrame());
		...
		FrameRecorder recorder = FrameRecorder.createDefault("D:/output1.mp4", width, height);
		recorder.start();
		...
		// correction.
		CanvasFrame frame = new CanvasFrame("Object Detector", CanvasFrame.getDefaultGamma() / grabber.getGamma());
